...
| [`second-runtime-throughput/`](second-runtime-throughput/) | decode speed on dflash-mlx-bonsai2 under `BENCHMARK.md` v1: ft5 / stock 1.0716 and ft5 / r3 1.0553 greedy, end to end (the server reports no decode timer) |
...
| [`throughput-ft5-procreations/`](throughput-ft5-procreations/) | decode speed on mlx-dspark under `BENCHMARK.md` v1, code prompts: ProCreations / ft5 0.9494 greedy, 0.9821 sampled; r3 / ft5 0.9041 greedy, 0.9324 sampled; ft5 accepts more on these prompts at the same round cost |
