...
| [`sampled-screen/`](sampled-screen/) | a pre-registration screen on mlx-dspark: decode at the target's published sampling, 24.07 against 26.30 tok/s (+9.3%; the protocol measured +6.73%, `throughput-ft5-procreations/`), and r3 4.63% below ft5 there |
...
| [`second-runtime-throughput/`](second-runtime-throughput/) | decode speed on dflash-mlx-bonsai2 under `BENCHMARK.md` v1: ft5 / stock 1.0716, ft5 / r3 1.0553 and ft5 / ProCreations 1.0164 greedy, end to end (the server reports no decode timer) |
...
| [`throughput-ft5-procreations/`](throughput-ft5-procreations/) | decode speed on mlx-dspark under `BENCHMARK.md` v1, code prompts: ft5 / stock 1.1523 greedy, 1.0673 sampled; ProCreations / ft5 0.9494 greedy, 0.9821 sampled; r3 / ft5 0.9041 greedy, 0.9324 sampled; ft5 accepts more on these prompts at the same round cost |
